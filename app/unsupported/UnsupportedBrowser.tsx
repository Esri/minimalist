        ...
        <div class={CSS.messageContainer}>
          ...
          <div class={CSS.browserIconContainer}>
            <img
              ...
              src="app/unsupported/assets/images/chrome.jpg"
              alt="Google Chrome Icon"
            />
            <img
              class={CSS.browserIcon}
              src="app/unsupported/assets/images/firefox.jpg"
              alt="Mozilla Firefox Icon"
            />
            <img class={CSS.browserIcon} src="app/unsupported/assets/images/safari.jpg" alt="Safari Icon" />
            {!this.isIE ? (
              <img
                class={CSS.browserIcon}
                src="app/unsupported/assets/images/new_edge.jpg"
