...
define(["require", "exports", "esri/core/Accessor", "dojo/i18n!../../nls/resources", "esri/core/accessorSupport/decorators", "../FeatureList"], function (require, exports, Accessor, i18n, decorators_1, FeatureList_1) {
    ...
    var PanelViewModel = /** @class */ (function (_super) {
        ...
        function PanelViewModel(props) {
            ...
            _this.actions = [];
            _this.view = null;
            _this._featureList = null;
            return _this;
        }
        PanelViewModel.prototype.init = function () {
        };
        ...
        PanelViewModel.prototype.createPopup = function (container) {
            ...
            this._featureList = new FeatureList_1.default({
        ...
        PanelViewModel.prototype.expandPanel = function (e) {
            var _a, _b;
        ...
        PanelViewModel.prototype.closePanel = function (e) {
        ...
        PanelViewModel.prototype.openPanel = function (e) {
            // open selected 
            var item = e.target;
        ...
        PanelViewModel.prototype.destroy = function () {
        };
        __decorate([
