...
export class CalciteFab {
    ...
    render() {
        ...
        return (h(Host, null,
            h("calcite-button", { class: CSS.button, loading: loading, disabled: disabled, title: title, "aria-label": label, theme: theme, dir: dir, scale: scale, icon: icon, round: true, floating: true, width: "auto", appearance: appearance, color: "blue", ref: (buttonEl) => {
