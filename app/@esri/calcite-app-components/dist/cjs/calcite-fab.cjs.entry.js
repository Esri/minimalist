...
const CalciteFab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("calcite-button", { class: CSS.button, loading: loading, disabled: disabled, title: title, "aria-label": label, theme: theme, dir: dir, scale: scale, icon: icon, round: true, floating: true, width: "auto", appearance: appearance, color: "blue", ref: (buttonEl) => {
