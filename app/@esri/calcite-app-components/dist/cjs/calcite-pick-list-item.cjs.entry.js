...
const resources$1 = require('./resources-1647306a.js');
...
const CalcitePickListItem = class {
    ...
    renderIcon() {
        ...
        const iconName = icon === resources.ICON_TYPES.square
            ? selected
                ? resources$1.ICONS.checked
                : resources$1.ICONS.unchecked
            : selected
                ? resources$1.ICONS.selected
                : resources$1.ICONS.unselected;
        return (index.h("span", { class: resources$1.CSS.icon }, index.h("calcite-icon", { scale: "s", icon: iconName })));
    }
    renderSecondaryAction() {
        const hasSecondaryAction = this.el.querySelector(`[slot=${resources$1.SLOTS.secondaryAction}]`);
        return hasSecondaryAction ? (index.h("div", { class: resources$1.CSS.action }, index.h("slot", { name: resources$1.SLOTS.secondaryAction }))) : null;
    }
    render() {
        ...
        return (index.h(index.Host, { role: "menuitemcheckbox", "aria-checked": this.selected.toString() }, index.h("label", { class: resources$1.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, tabIndex: 0, "aria-label": this.textLabel }, this.renderIcon(), index.h("div", { class: resources$1.CSS.textContainer }, index.h("span", { class: resources$1.CSS.title }, this.textLabel), description)), this.renderSecondaryAction()));
    }
