...
const CalciteFilter = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, null, index.h("label", null, index.h("input", { type: "text", value: "", placeholder: this.textPlaceholder, onInput: this.inputHandler, "aria-label": this.textLabel || TEXT.filterLabel, ref: (el) => (this.textInput = el) }), index.h("div", { class: CSS.searchIcon }, index.h("calcite-icon", { scale: "s", icon: ICONS.search }))), !this.empty ? (index.h("button", { onClick: this.clear, class: CSS.clearButton, "aria-label": TEXT.clear }, index.h("calcite-icon", { icon: ICONS.close }))) : null));
    }
