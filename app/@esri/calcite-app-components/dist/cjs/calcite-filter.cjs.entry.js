...
const CalciteFilter = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, null, index.h("label", null, index.h("input", { type: "text", value: "", placeholder: this.placeholder || this.textPlaceholder, onInput: this.inputHandler, "aria-label": this.intlLabel || this.textLabel || TEXT.filterLabel, ref: (el) => {
                this.textInput = el;
