...
const CalciteShell = class {
    ...
    renderMain() {
        ...
        const mainClasses = {
            [CSS.mainReversed]: dom.getCalcitePosition(primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.position, primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.layout) === "end"
        };
        return (index.h("div", { class: index$1.classnames(CSS.main, mainClasses) }, index.h("slot", { name: SLOTS.primaryPanel }), this.renderContent(), index.h("slot", { name: SLOTS.contextualPanel }), index.h("slot", { name: SLOTS.tipManager })));
    }
    render() {
...
const CalciteShellPanel = class {
    ...
    render() {
        ...
        const contentNode = (index.h("div", { class: index$1.classnames(CSS$1.content, { [CSS$1.contentDetached]: detached }), hidden: collapsed }, index.h("slot", null)));
        const actionBarNode = index.h("slot", { name: SLOTS$1.actionBar });
        const mainNodes = [actionBarNode, contentNode];
        if (dom.getCalcitePosition(position, layout) === "end") {
            mainNodes.reverse();
        }
