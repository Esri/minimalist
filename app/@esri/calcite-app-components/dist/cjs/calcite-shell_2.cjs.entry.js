...
const CalciteShell = class {
    ...
    renderMain() {
        ...
        const mainClasses = {
            [CSS.mainReversed]: index$1.getCalcitePosition((_a = primaryPanel) === null || _a === void 0 ? void 0 : _a.position, (_b = primaryPanel) === null || _b === void 0 ? void 0 : _b.layout) === "end"
        };
...
const CalciteShellPanel = class {
    ...
    render() {
        ...
        if (index$1.getCalcitePosition(position, layout) === "end") {
            mainNodes.reverse();
        }
