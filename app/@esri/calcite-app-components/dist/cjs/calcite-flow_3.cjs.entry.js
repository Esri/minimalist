...
const CalciteFlowItem = class {
    ...
    renderSingleActionContainer() {
        return (index.h("div", { class: CSS$1.singleActionContainer }, index.h("slot", { name: SLOTS.menuActions })));
    }
    ...
    renderHeading() {
        const { heading } = this;
        return heading ? (index.h("h2", { class: CSS$1.heading, slot: SLOTS$1.headerContent }, heading)) : null;
    }
    renderSummary() {
        const { summary } = this;
        return summary ? index.h("span", { class: CSS$1.summary }, summary) : null;
    }
    renderHeader() {
...
const CalcitePanel = class {
    ...
    renderHeader() {
        ...
        return canDisplayHeader ? (index.h("header", { class: CSS$2.header }, headerLeadingContentNode, headerContentNode, headerTrailingContentNode)) : null;
    }
    renderFooter() {
        const { el } = this;
