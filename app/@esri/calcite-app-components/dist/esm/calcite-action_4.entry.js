...
const CalciteAction = class {
    ...
    render() {
        ...
        return (h(Host, null, h("button", { class: classnames(CSS.button, buttonClasses), title: title, "aria-label": title, disabled: disabled, "aria-disabled": disabled.toString(), "aria-busy": loading.toString(), ref: (buttonEl) => (this.buttonEl = buttonEl) }, this.renderIconContainer(), this.renderTextContainer())));
    }
...
const CalciteActionBar = class {
    ...
    renderBottomActionGroup() {
        ...
        const expandToggleNode = expand ? (h(CalciteExpandToggle, { expanded: expanded, textExpand: textExpand, textCollapse: textCollapse, el: el, position: getCalcitePosition$1(position, layout), toggleExpand: toggleExpand })) : null;
