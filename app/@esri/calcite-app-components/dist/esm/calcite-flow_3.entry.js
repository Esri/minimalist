...
const CalcitePanel = class {
    ...
    renderHeaderTrailingContent() {
        ...
        const dismissibleNode = dismissible ? (h("calcite-action", { ref: (dismissButtonEl) => (this.dismissButtonEl = dismissButtonEl), "aria-label": textClose, text: textClose, onClick: dismiss }, h("calcite-icon", { scale: "s", icon: ICONS$1.close }))) : null;
