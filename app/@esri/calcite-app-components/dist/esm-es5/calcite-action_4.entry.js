...
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-1a2740c5.js';
import { c as classnames, g as getElementDir, a as getCalcitePosition$1 } from './index-4570617c.js';
import { C as CSS_UTILITY } from './resources-a565c445.js';
var CSS = {
    button: "button",
...
var CalciteAction = /** @class */ (function () {
    ...
    class_1.prototype.renderTextContainer = function () {
        var _a;
        var _b = this, text = _b.text, textEnabled = _b.textEnabled;
        var textContainerClasses = (_a = {},
            _a[CSS.textContainerVisible] = textEnabled,
            _a);
    ...
    class_1.prototype.renderIconContainer = function () {
        ...
        var calciteLoaderNode = h("calcite-loader", { "is-active": true, inline: true });
        var slotContainerNode = (h("div", { class: classnames(CSS.slotContainer, (_a = {},
                _a[CSS.slotContainerHidden] = loading,
                _a)) }, h("slot", null)));
        var iconNode = loading
            ? calciteLoaderNode
    ...
    class_1.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this, compact = _b.compact, disabled = _b.disabled, loading = _b.loading, el = _b.el, textEnabled = _b.textEnabled, label = _b.label, text = _b.text;
        var titleText = !textEnabled && text;
        var title = label || titleText;
        var rtl = getElementDir(el) === "rtl";
        var buttonClasses = (_a = {},
            _a[CSS.buttonTextVisible] = textEnabled,
            _a[CSS.buttonCompact] = compact,
            _a[CSS_UTILITY.rtl] = rtl,
            _a);
        return (h(Host, null, h("button", { class: classnames(CSS.button, buttonClasses), title: title, "aria-label": title, disabled: disabled, "aria-disabled": disabled.toString(), "aria-busy": loading.toString(), ref: function (buttonEl) { return (_this.buttonEl = buttonEl); } }, this.renderIconContainer(), this.renderTextContainer())));
    };
...
function toggleChildActionText(_a) {
    var parent = _a.parent, expanded = _a.expanded;
    parent.querySelectorAll("calcite-action").forEach(function (action) { return (action.textEnabled = expanded); });
}
var CalciteExpandToggle = function (_a) {
    var expanded = _a.expanded, textExpand = _a.textExpand, textCollapse = _a.textCollapse, toggleExpand = _a.toggleExpand, el = _a.el, position = _a.position;
    var rtl = getElementDir(el) === "rtl";
    ...
    return (h("calcite-action", { onClick: toggleExpand, textEnabled: expanded, text: expandText }, h("calcite-icon", { scale: "s", icon: expanded ? expandIcon : collapseIcon })));
};
var CSS$1 = {
...
var CalciteActionBar = /** @class */ (function () {
    ...
    CalciteActionBar.prototype.componentWillLoad = function () {
        var _a = this, el = _a.el, expand = _a.expand, expanded = _a.expanded;
        if (expand) {
    ...
    CalciteActionBar.prototype.renderBottomActionGroup = function () {
        var _a = this, expanded = _a.expanded, expand = _a.expand, textExpand = _a.textExpand, textCollapse = _a.textCollapse, el = _a.el, layout = _a.layout, position = _a.position, toggleExpand = _a.toggleExpand;
        var expandToggleNode = expand ? (h(CalciteExpandToggle, { expanded: expanded, textExpand: textExpand, textCollapse: textCollapse, el: el, position: getCalcitePosition$1(position, layout), toggleExpand: toggleExpand })) : null;
        return this.el.querySelector("[slot=" + SLOTS.bottomActions + "]") || expandToggleNode ? (h("calcite-action-group", { class: CSS$1.actionGroupBottom }, h("slot", { name: SLOTS.bottomActions }), expandToggleNode)) : null;
    };
    ...
    Object.defineProperty(CalciteActionBar, "style", {
...
var CalciteActionGroup = /** @class */ (function () {
    ...
    Object.defineProperty(CalciteActionGroup, "style", {
...
var CalciteActionPad = /** @class */ (function () {
    ...
    Object.defineProperty(CalciteActionPad, "style", {
