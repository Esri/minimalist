...
import { c as classnames, f as focusElement, g as getElementDir } from './index-4570617c.js';
    ...
    class_1.prototype.back = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                beforeBack = lastItem.beforeBack ? lastItem.beforeBack : function () { return Promise.resolve(); };
...
var CalciteFlowItem = /** @class */ (function () {
    ...
    CalciteFlowItem.prototype.renderBackButton = function (rtl) {
        var _c = this, showBackButton = _c.showBackButton, textBack = _c.textBack, backButtonClick = _c.backButtonClick;
        var icon = rtl ? ICONS.backRight : ICONS.backLeft;
        return showBackButton ? (h("calcite-action", { slot: SLOTS$1.headerLeadingContent, key: "back-button", "aria-label": textBack, text: textBack, class: CSS$1.backButton, onClick: backButtonClick }, h("calcite-icon", { scale: "s", filled: true, icon: icon }))) : null;
    };
    CalciteFlowItem.prototype.renderMenuButton = function () {
        var _c = this, menuOpen = _c.menuOpen, textOpen = _c.textOpen, textClose = _c.textClose;
        var menuLabel = menuOpen ? textClose : textOpen;
        return (h("calcite-action", { class: CSS$1.menuButton, "aria-label": menuLabel, text: menuLabel, onClick: this.toggleMenuOpen, onKeyDown: this.menuButtonKeyDown }, h("calcite-icon", { scale: "s", icon: ICONS.menu })));
    };
    ...
    CalciteFlowItem.prototype.renderFooterActions = function () {
        var hasFooterActions = !!this.el.querySelector("[slot=" + SLOTS.footerActions + "]");
    ...
    CalciteFlowItem.prototype.renderHeaderActions = function () {
        var menuActionsNode = this.el.querySelector("[slot=" + SLOTS.menuActions + "]");
        var hasMenuActionsInBlacklisted = menuActionsNode && menuActionsNode.closest(BLACKLISTED_MENU_ACTIONS_COMPONENTS.join(","));
        var hasMenuActions = !!menuActionsNode && !hasMenuActionsInBlacklisted;
    ...
    CalciteFlowItem.prototype.render = function () {
        ...
        return (h(Host, null, h("calcite-panel", { loading: this.loading, disabled: this.disabled, "height-scale": this.heightScale, dir: dir }, this.renderBackButton(dir === "rtl"), this.renderHeader(), this.renderHeaderActions(), h("slot", null), this.renderFooterActions())));
    };
    ...
    Object.defineProperty(CalciteFlowItem, "style", {
...
var CalcitePanel = /** @class */ (function () {
    ...
    class_2.prototype.renderHeaderLeadingContent = function () {
        var hasLeadingContent = this.el.querySelector("[slot=" + SLOTS$1.headerLeadingContent + "]");
    ...
    class_2.prototype.renderHeaderTrailingContent = function () {
        var _this = this;
        var _c = this, dismiss = _c.dismiss, dismissible = _c.dismissible, textClose = _c.textClose;
        var dismissibleNode = dismissible ? (h("calcite-action", { ref: function (dismissButtonEl) { return (_this.dismissButtonEl = dismissButtonEl); }, "aria-label": textClose, text: textClose, onClick: dismiss }, h("calcite-icon", { scale: "s", icon: ICONS$1.close }))) : null;
