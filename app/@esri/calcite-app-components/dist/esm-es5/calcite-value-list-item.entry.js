...
import { r as registerInstance, h, H as Host, g as getElement } from './index-1a2740c5.js';
import { a as guid } from './guid-715b8407.js';
import { I as ICON_TYPES } from './resources-1839192e.js';
import { C as CSS } from './resources-6e7bc880.js';
var ICONS = {
    drag: "drag"
};
var CalciteValueListItem = /** @class */ (function () {
    ...
    class_1.prototype.renderHandle = function () {
        ...
        if (icon === ICON_TYPES.grip) {
            return (h("span", { role: "button", class: (_a = {}, _a[CSS.handle] = true, _a[CSS.handleActivated] = this.handleActivated, _a), tabindex: "0", "data-js-handle": "true", "aria-pressed": this.handleActivated.toString(), onKeyDown: this.handleKeyDown, onBlur: this.handleBlur }, h("calcite-icon", { scale: "s", icon: ICONS.drag })));
        }
    };
    class_1.prototype.render = function () {
        return (h(Host, { "data-id": this.guid }, this.renderHandle(), h("calcite-pick-list-item", { compact: this.compact, ref: this.getPickListRef, disabled: this.disabled, disableDeselect: this.disableDeselect, selected: this.selected, metadata: this.metadata, textLabel: this.textLabel, textDescription: this.textDescription, onCalciteListItemChange: this.handleSelectChange, value: this.value }, h("slot", { name: "secondary-action", slot: "secondary-action" }))));
    };
