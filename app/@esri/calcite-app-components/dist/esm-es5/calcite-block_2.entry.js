...
import { g as guid } from './guid-715b8407.js';
var CSS = {
    content: "content",
...
var CalciteBlock = /** @class */ (function () {
    ...
    CalciteBlock.prototype.render = function () {
        var _a = this, collapsible = _a.collapsible, disabled = _a.disabled, el = _a.el, heading = _a.heading, loading = _a.loading, open = _a.open, summary = _a.summary, textCollapse = _a.textCollapse, textExpand = _a.textExpand;
        var toggleLabel = open ? textCollapse : textExpand;
        var hasIcon = el.querySelector("[slot=" + "icon" /* icon */ + "]");
        ...
        var slottedControl = el.querySelector("[slot=" + "control" /* control */ + "]");
        var headerNode = (h("div", { class: CSS.headerContainer }, this.dragHandle ? h("calcite-handle", null) : null, collapsible ? (h("button", { "aria-label": toggleLabel, class: CSS.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, slottedControl ? null : (h("calcite-icon", { scale: "s", icon: open ? ICONS.close : ICONS.open })))) : (headerContent), loading ? (h("calcite-loader", { inline: true, "is-active": true })) : (h("slot", { name: "control" /* control */ }))));
...
var CalciteBlockSection = /** @class */ (function () {
    ...
    CalciteBlockSection.prototype.render = function () {
        var _a = this, el = _a.el, id = _a.guid, open = _a.open, text = _a.text, textCollapse = _a.textCollapse, textExpand = _a.textExpand, toggleDisplay = _a.toggleDisplay;
    ...
    Object.defineProperty(CalciteBlockSection, "style", {
