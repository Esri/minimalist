...
var CalciteShell = /** @class */ (function () {
    ...
    CalciteShell.prototype.renderMain = function () {
        ...
        var mainClasses = (_a = {},
            _a[CSS.mainReversed] = getCalcitePosition(primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.position, primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.layout) === "end",
            _a);
...
var CalciteShellPanel = /** @class */ (function () {
    ...
    CalciteShellPanel.prototype.render = function () {
        var _a;
        var _b = this, collapsed = _b.collapsed, detached = _b.detached, layout = _b.layout, position = _b.position;
        var contentNode = (h("div", { class: classnames(CSS$1.content, (_a = {}, _a[CSS$1.contentDetached] = detached, _a)), hidden: collapsed }, h("slot", null)));
        var actionBarNode = h("slot", { name: SLOTS$1.actionBar });
