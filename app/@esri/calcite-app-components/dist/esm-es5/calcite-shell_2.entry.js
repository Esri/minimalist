...
import { c as classnames, a as getCalcitePosition } from './index-4570617c.js';
var CSS = {
    main: "main",
...
var CalciteShell = /** @class */ (function () {
    ...
    CalciteShell.prototype.renderHeader = function () {
        var hasHeader = !!this.el.querySelector("[slot=" + SLOTS.header + "]");
    ...
    CalciteShell.prototype.renderFooter = function () {
        var hasFooter = !!this.el.querySelector("[slot=" + SLOTS.footer + "]");
        return hasFooter ? (h("div", { class: CSS.footer }, h("slot", { name: SLOTS.footer }))) : null;
    };
    CalciteShell.prototype.renderMain = function () {
        var _c;
        var _a, _b;
        var primaryPanel = this.el.querySelector("[slot=" + SLOTS.primaryPanel + "]");
        var mainClasses = (_c = {},
            _c[CSS.mainReversed] = getCalcitePosition((_a = primaryPanel) === null || _a === void 0 ? void 0 : _a.position, (_b = primaryPanel) === null || _b === void 0 ? void 0 : _b.layout) === "end",
            _c);
    ...
    Object.defineProperty(CalciteShell, "style", {
...
var CalciteShellPanel = /** @class */ (function () {
    ...
    CalciteShellPanel.prototype.render = function () {
        var _c;
        var _d = this, collapsed = _d.collapsed, detached = _d.detached, layout = _d.layout, position = _d.position;
        var contentNode = (h("div", { class: classnames(CSS$1.content, (_c = {}, _c[CSS$1.contentDetached] = detached, _c)), hidden: collapsed }, h("slot", null)));
    ...
    Object.defineProperty(CalciteShellPanel, "style", {
