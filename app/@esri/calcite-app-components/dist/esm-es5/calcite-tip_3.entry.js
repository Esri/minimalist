...
var CalciteTip = /** @class */ (function () {
    ...
    CalciteTip.prototype.renderHeader = function () {
        var _a = this, nonDismissible = _a.nonDismissible, hideTip = _a.hideTip, textClose = _a.textClose, heading = _a.heading;
        var dismissButtonNode = !nonDismissible ? (h("calcite-action", { text: textClose, onClick: hideTip, class: CSS.close }, h("calcite-icon", { scale: "s", icon: ICONS.close }))) : null;
    ...
    Object.defineProperty(CalciteTip, "style", {
...
var CalciteTipGroup = /** @class */ (function () {
    ...
    Object.defineProperty(CalciteTipGroup, "style", {
...
var CalciteTipManager = /** @class */ (function () {
    ...
    class_1.prototype.renderPagination = function () {
        ...
        var _a = this, selectedIndex = _a.selectedIndex, tips = _a.tips, total = _a.total;
    ...
    class_1.prototype.render = function () {
        var _a;
        var _b = this, closed = _b.closed, direction = _b.direction, groupTitle = _b.groupTitle, selectedIndex = _b.selectedIndex, textClose = _b.textClose, total = _b.total;
        if (total === 0) {
            return h(Host, null);
        }
