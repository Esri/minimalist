...
var CalciteFilter = /** @class */ (function () {
    ...
    CalciteFilter.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("label", null, h("input", { type: "text", value: "", placeholder: this.placeholder || this.textPlaceholder, onInput: this.inputHandler, "aria-label": this.intlLabel || this.textLabel || TEXT.filterLabel, ref: function (el) {
                _this.textInput = el;
