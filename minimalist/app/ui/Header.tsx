...
class Header extends (Widget) {
  ...
  initialize() {
    ...
    this.own([whenOnce(this, "view.ready", async () => {
      ...
      const { theme, applySharedTheme } = this.applicationConfig;
      ...
      if (this._applySharedTheme && this?.sharedTheme?.text) {
        color = this.sharedTheme.text;
      }
      let customTheme = color ? `
  ...
  renderShare() {
    ...
    const { theme, share, shareIncludeSocial, applySharedTheme } = this.applicationConfig;
